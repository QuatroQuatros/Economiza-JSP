  ...
  <body>
    ...
    <script type="text/javascript">
      function gerarArray() {
        ...
        resultado.push(["Mês", "Economia"]);
        for (let i = 0; i < meses.length; i++) {
          const data = `${meses[i]}/${ano}`;
          const valor = Math.floor(Math.random() * 500) - 250; // Gera valores aleatórios entre -250 e 250
      ...
      function drawChart() {
        ...
        var options = {
          ...
          titleTextStyle: { color: "#A5A0F5" }, // Defina a cor do título
          hAxis: {
