  ...
  <body>
    <div class="container d-flex justify-content-center align-items-center">
      <div class="container-fluid container-form">
        ...
        <form method="POST" action="register" enctype="multipart/form-data">
          <div class="form-group mb-2">
            ...
            <input
              ...
              name="nome"
              id="nome"
              placeholder="Raul Santos Seixas"
              required
            />
          </div>
          <div class=" form-group mb-2">
              <label for="cpf" class="form-label">CPF</label>
              <input type="text" class="form-control" name="cpf" id="cpf" placeholder="123.123.123-34" oninput="this.value = mascaraCpf(this.value)" maxlength="14" required>
          </div>
          <div class="form-group mb-2">
          ...
          <button class="btn btn-md btn-cadastrar" type="submit">
            Cadastrar
          </button>
        </form>
        <div class="app-login">
        ...
        <a href="./login.jsp" class="link-register">Já possui conta? Login</a>
      </div>
